...
def parse_arguments():
    ...
    parser.add_argument("--dataset", type=str, choices=['nuscenes', 'once', 'waymo'], default='once', help="Dataset.")
    parser.add_argument("--version", type=str, default="v1.0-mini", help="NuScenes version.")
    parser.add_argument("--split", type=str, choices=['train', 'test', 'val', 'raw_small', 'raw_medium', 'raw_large'], default="raw_small", help="Once dataset type.")
    parser.add_argument("--dataroot", type=str, default="D:/", help="Data root location.")
    parser.add_argument("--strategy", type=str, default="default", help="Accumulation strategy.")
    parser.add_argument("--instances", type=bool, default=True, help="Export instances.")
    parser.add_argument("--frames", type=bool, default=True, help="Export frames.")
