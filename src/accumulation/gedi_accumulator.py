...
class GediAccumulator:
    ...
    def __init__(self,
        ...
        self.__scene_instances = {}  # Key: instance_id, Value: SceneInstance object

    def add_scene_instance(self, instance_id: str, category: str):
        # Create a new SceneInstance object and add it to the dictionary
